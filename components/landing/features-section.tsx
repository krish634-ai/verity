...
const features = [
  {
    ...
    description: "VERITY's voice analysis engine detects tone, confidence, and emotion in real time — giving you a deeper signal beyond just what candidates say.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "AI Interviewer Engine",
    description: "An adaptive AI interviewer that asks contextual follow-up questions, adjusts difficulty based on responses, and evaluates answers with human-level nuance.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Interview Transparency",
    description: "Every evaluation is explainable. Candidates and hiring teams receive a full breakdown of scores, reasoning, and evidence from the interview session.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Bias-Free Assessment",
    description: "Standardized evaluation criteria eliminate unconscious bias. Every candidate is measured against the same objective benchmarks.",
    visual: "security",
  },
];
...
// Pre-calculated positions to avoid hydration mismatch from floating-point math
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Beyond the resume.
            <br />
            <span className="text-muted-foreground">Beyond the script.</span>
          </h2>
        </div>
